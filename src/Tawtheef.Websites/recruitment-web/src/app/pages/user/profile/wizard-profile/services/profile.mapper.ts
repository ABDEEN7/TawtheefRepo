...
export function mapProfileStatusToState(
  ...
  return {
    ...
    experiences: (dto.experiences ?? []).map(e => ({
      ...
      country: mapIdToDropdown(lookups, 'graduationCountry', e.countryId),
      current: e.isCurrent,
    ...
    courses: (dto.trainingCourses ?? []).map(t => ({
      ...
      country: mapIdToDropdown(lookups, 'graduationCountry', t.countryId),
    ...
    achievements: (dto.achievements ?? []).map(a => ({
      ...
      achievementType: mapIdToDropdown(lookups, 'achievementTypes', a.achievementTypeId),
      title: a.title ?? '',
      issuingAuthority: a.issuingAuthority ?? '',
      countryId: a.countryId,
      country: mapIdToDropdown(lookups, 'graduationCountry', a.countryId),
      issueDate: a.issueDate ?? undefined,
