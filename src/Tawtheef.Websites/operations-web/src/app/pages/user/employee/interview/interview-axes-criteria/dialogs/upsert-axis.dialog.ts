...
export interface UpsertAxisDialogData {
  mode: DialogMode;
  model?: AxisModel;
}

@Component({
  selector: 'app-upsert-axis-dialog',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class UpsertAxisDialogComponent {
  ref = inject(DynamicDialogRef);
  config = inject(DynamicDialogConfig<UpsertAxisDialogData>);
