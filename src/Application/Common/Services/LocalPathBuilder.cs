...
public static class LocalPathBuilder
{
    ...
    public static string InvitationExceptionProof(Guid exceptionId, Guid fileId, string ext, string hash)
        => Key("private", "operation", "exceptions", exceptionId.ToString(), "proof", FileName(fileId, hash, ext));
