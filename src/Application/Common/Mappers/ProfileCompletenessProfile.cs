    ...
    public void Register(TypeAdapterConfig config)
    {
        ...
        config.NewConfig<ProfileBootstrapSource, ProfileStatusDto>()
            ...
            .Map(dest => dest.IsKawaderQid,
                src => (src.User as ApplicantUser) != null
                       && ((ApplicantUser)src.User).IsUserKawader)            
            ...
            .Map(dest => dest.NationalCard, src => src.Profile.NationalCard)
            .Map(dest => dest.BirthdayCertificate, src => src.Profile.BirthdayCertificate)
            .Map(dest => dest.MarriageCertificate, src => src.Profile.MarriageCertificate)
            
            .Map(dest => dest.FullNameAr, src => string.IsNullOrWhiteSpace(src.User.FullNameAr) ? src.Prefill.FullName : src.User.FullNameAr)
            .Map(dest => dest.FullNameEn, src => string.IsNullOrWhiteSpace(src.User.FullNameEn)  ? src.Prefill.FullName : src.User.FullNameEn)
            ...
            .Map(dest => dest.SponsorType, src => src.Profile.SponsorProfile == null ? null : src.Profile.SponsorProfile.SponsorType)
