    ...
    : IRequestHandler<DecideProfileReviewItemCommand, IResult<Unit>>
{
    ...
    private sealed record PrereqSnapshot
    {
    ...
    private sealed record PersonalSnapshot
    {
    ...
    private sealed record PendingQualificationSnapshot
    {
    ...
    private sealed record PendingExperienceSnapshot
    {
    ...
    private sealed record PendingTrainingSnapshot
    {
    ...
    private sealed record PendingAchievementSnapshot
    {
