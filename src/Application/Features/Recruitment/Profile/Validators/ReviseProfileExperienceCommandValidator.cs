...
public sealed class ReviseProfileExperienceCommandValidator : AbstractValidator<ReviseProfileExperienceCommand>
{
    public ReviseProfileExperienceCommandValidator()
    {
