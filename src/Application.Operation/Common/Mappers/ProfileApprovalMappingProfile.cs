...
public sealed class ProfileApprovalMappingProfile : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        config.NewConfig<ReviewItem, ProfileApprovalItemDto>()
            ...
            .Map(dest => dest.FieldPath, src => src.FieldPath)
...
//-----------------
        ...
        config.NewConfig<UserProfile, BasicInformationSnapshot>()
            ...
            .Map(dest => dest.SponsorTypeBackendName, src => src.SponsorProfile != null && src.SponsorProfile.SponsorType != null ? src.SponsorProfile.SponsorType.BackendName : null)
