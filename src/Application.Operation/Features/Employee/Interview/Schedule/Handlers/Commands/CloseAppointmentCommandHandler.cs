...
public sealed class CloseAppointmentCommandHandler(IUnitOfWork unitOfWork)
    : IRequestHandler<CloseAppointmentCommand, IResult<Unit>>
{
    public async Task<IResult<Unit>> Handle(CloseAppointmentCommand request, CancellationToken cancellationToken)
    {
